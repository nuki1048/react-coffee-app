...
import bg from "../../assets/img/second_main_bg.jpg";
import img from "../../assets/img/coffee-details.jpg";
...
const OurCoffeeDetails = () => {
  ...
  return (
    <section className="our-coffee-details">
      <Header tittle={"Our Coffee"} path={bg} />
    ...
    <div className="item">
      ...
      <div key={0} className="item-info">
        ...
        <div className="item-info__description">
          ...
          adipisicing elit. Blanditiis error fugit similique id eaque
          laboriosam? Aspernatur animi, sunt aut officiis iste adipisci
          repellendus facere minima, cumque unde voluptatem natus. Suscipit.
        </div>
