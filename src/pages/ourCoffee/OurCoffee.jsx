...
import preview from "../../assets/img/aboutPhoto.jpg";
import img from "../../assets/img/second_main_bg.jpg";
...
const OurCoffee = () => {
  ...
  return (
    <>
      <Header tittle={"Our Coffee"} path={img} />
      <AboutComponent title={"About our beans"} path={preview} />
